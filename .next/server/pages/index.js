...
;// CONCATENATED MODULE: ./components/CategoryMenu.js
...
function CategoryMenu({ categories  }) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)("nav", {
        ...
        children: [
            ...
            categories.map((cat)=>/*#__PURE__*/ jsx_runtime.jsx("button", {
...
function ProductCard({ product  }) {
    const { addToCart  } = (0,external_react_.useContext)(_app.CartContext);
...
function ProductList({ products  }) {
    ...
    const filtered = query.category ? products.filter((p)=>p.category === query.category) : products;
    return /*#__PURE__*/ jsx_runtime.jsx("div", {
        className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6",
        children: filtered.map((prod)=>/*#__PURE__*/ jsx_runtime.jsx(ProductCard, {
                product: prod
            }, prod.id))
    });
}
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)("main", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ jsx_runtime.jsx(CategoryMenu, {
                        categories: categories
                    }),
                    /*#__PURE__*/ jsx_runtime.jsx(ProductList, {
                        products: products
                    })
                ]
            })
...
async function getStaticProps({ locale  }) {
    ...
    const products = __webpack_require__(8220);
...
module.exports = JSON.parse('[{"id":1,"name":"Борщ","category":"Супи","price":75,"image":"/images/borshch.jpg"},{"id":2,"name":"Вареники з картоплею","category":"Вареники","price":90,"image":"/images/vareniki.jpg"},{"id":3,"name":"Гречка з м\'ясом","category":"Гарніри","price":65,"image":"/images/grechka.jpg"}]');
...
var __webpack_exports__ = __webpack_require__.X(0, [812,664,4,97], () => (__webpack_exec__(729)));
